...
const Loading = () => {
  return (
    <Card className="w-full p-5 mx-auto max-w-2xl text-center rounded-xl">
      <div class="mb-4 w-full flex items-center space-x-2">
        <div class="animate-pulse rounded-full bg-gray-500 h-5 w-5" />
        <div class="animate-pulse rounded-md bg-gray-500 h-7 w-[200px]" />
        <div class="space-y-2">
      ...
      <div class="mb-4">
        <div class="mb-4 animate-pulse rounded-md bg-gray-500 h-3 w-[200px]" />
        <div class="mb-3 animate-pulse rounded-full bg-gray-500 h-3 w-full" />
      ...
      <div>
        <div className='mb-3 w-full flex items-center space-x-2'>
          ...
          <div class="animate-pulse rounded-md bg-gray-500 h-10 w-full" />
        </div>
        <div className='mb-3 w-full flex items-center space-x-2'>
          <div class="animate-pulse rounded-sm bg-gray-500 h-5 w-5" />
          <div class="animate-pulse rounded-md bg-gray-500 h-10 w-full" />
